...
let kayıtısz = ayarlar.kayıtsızROL2

client.on("guildMemberAdd", member => {
  member.setNickname(`• İsim | Yaş`)
  member.roles.add(kayıtsız);
  member.roles.add(kayıtısz)
});
    ...
    require("moment-duration-format")
      ...
      if(üs) {
        üyesayısı = üyesayısı.replace(/([0-9999])/g, d => {
          return {
            '0': `<a:revolts_0:777236510771773440>`,
            '1': `<a:revolts_1:777236093900161054>`,
            '2': `<a:revolts_2:777236113902665810>`,
            '3': `<a:revolts_3:777236141224230952>`,
            '4': `<a:revolts_4:777236167761592390>`,                       
            '5': `<a:revolts_5:777236339841957899>`,
            '6': `<a:revolts_6:777236384738050068>`,
            '7': `<a:revolts_7:777236413921755166>`,
            '8': `<a:revolts_8:777236444103704576>`,
            '9': `<a:revolts_9:777236474009485352>`}[d];})}
    const kanal = member.guild.channels.cache.find(r => r.id === "806158601927655477");
...
Bu Roldeki Arkadaşlarım Seninle İlgilenecektir  <@&806158601524740143> 
...
client.on("userUpdate", async (oldUser, newUser) => {
  ...
  const tag = '♱'
  const sunucu = '806158601223143434'
  const log = '806568579851485234'
  const rol = '806158601478733866'
...
const voiceChannel = "806566070336880640"
