...
let kadınrol2 = message.guild.roles.cache.find(r => r.id === ayarlar.kadınICON)
let kadınrol3 = message.guild.roles.cache.find(r => r.id === ayarlar.kadınSEMBOL)
let kayıtsız = message.guild.roles.cache.find(r => r.id === ayarlar.kayıtsızROL)
let kayıtısz = message.guild.roles.cache.find(r => r.id === ayarlar.kayıtsızROL2)
